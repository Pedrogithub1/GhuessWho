...
class DialogBoxAccesories(contexto: Context?, private val interfaz: EndDialogBox, personaje: String, arrayPersonaje: Array<Array<Int>>, index: Int) {
    ...
    init {
        ...
        aceptar.setOnClickListener {
            var resp = " "
            if(mensaje == "¿Tiene Sombrero?"){
                if(arrayPersonaje[index][2] == 1){
                    resp = "Si"
                }
                else if(arrayPersonaje[index][2]== 0){
                    resp = "No"
                }
            }
            else if(mensaje == "¿Tiene Cadena?"){
                if(arrayPersonaje[index][3] == 1){
                    resp = "Si"
                }
                else if(arrayPersonaje[index][3] == 0){
                    resp = "No"
                }
            }
            else if(mensaje == "¿Tiene Pelo?"){
                if(arrayPersonaje[index][4] == 1){
                    resp = "Si"
                }
                else if(arrayPersonaje[index][4] == 0){
                    resp = "No"
                }
            }
            else if(mensaje == "¿Tienes Aretes?"){
                if(arrayPersonaje[index][5] == 1){
                    resp = "Si"
                }
                else if(arrayPersonaje[index][5] == 0){
                    resp = "No"
                }
            }
            else if(mensaje == "¿Tienes Lentes?"){
                if(arrayPersonaje[index][6] == 1){
                    resp = "Si"
                }
                else if(arrayPersonaje[index][6] == 0){
                    resp = "No"
                }
            }
