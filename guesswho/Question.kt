...
class Question(contexto: Context?, private val interfaz: EndDialogBox) {
    ...
    init {
        ...
        dialogo.setContentView(R.layout.question)
        val mensaje = dialogo.findViewById<View>(R.id.mensaje) as EditText
