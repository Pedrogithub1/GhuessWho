...
class DialogBoxHair(contexto: Context?, private val interfaz: EndDialogBox, personaje: String, arrayPersonaje: Array<Array<Int>>, index: Int) {
    ...
    init {
        ...
        aceptar.setOnClickListener {
            var resp = " "
            if(mensaje == "¿Tiene el pelo largo?"){
                if(arrayPersonaje[index][10] == 1){
                    resp = "Si"
                }
                else if(arrayPersonaje[index][10]== 0){
                    resp = "No"
                }
            }
            else if(mensaje == "¿Tiene el pelo corto?"){
                if(arrayPersonaje[index][11] == 1){
                    resp = "Si"
                }
                else if(arrayPersonaje[index][11] == 0){
                    resp = "No"
                }
            }
            else if(mensaje == "¿Tiene Barba?"){
                if(arrayPersonaje[index][12] == 1){
                    resp = "Si"
                }
                else if(arrayPersonaje[index][12] == 0){
                    resp = "No"
                }
            }
            else if(mensaje == "¿Tienes Bigote?"){
                if(arrayPersonaje[index][13] == 1){
                    resp = "Si"
                }
                else if(arrayPersonaje[index][13] == 0){
                    resp = "No"
                }
            }
            else if(mensaje == "¿Es Calvo?"){
                if(arrayPersonaje[index][14] == 1){
                    resp = "Si"
                }
                else if(arrayPersonaje[index][14] == 0){
                    resp = "No"
                }
            }
            else if(mensaje == "¿Tienes el pelo negro?"){
                if(arrayPersonaje[index][15] == 1){
                    resp = "Si"
                }
                else if(arrayPersonaje[index][15] == 0){
                    resp = "No"
                }
            }
            else if(mensaje == "¿Tiene el pelo rubio?"){
                if(arrayPersonaje[index][16] == 1){
                    resp = "Si"
                }
                else if(arrayPersonaje[index][16] == 0){
                    resp = "No"
                }
            }
